...
CPP_SOURCES = $(SRC_DIR)/main.cpp $(SRC_DIR)/render.cpp $(SRC_DIR)/input.cpp $(SRC_DIR)/cubo.cpp $(SRC_DIR)/acuario.cpp $(SRC_DIR)/esfera.cpp $(SRC_DIR)/camaras.cpp $(SRC_DIR)/tiempo.cpp $(SRC_DIR)/pez.cpp
